...
template< typename T1,
          typename T2 >
inline auto
operator/(const has_division<T1> &lhs, const has_division<T2> &rhs)
-> const Div<T1, T2> {
...
template< typename T1,
          typename T2 >
inline auto
operator/(const has_division<T1> &lhs, const T2 &rhs)
...
template< typename T1,
          typename T2 >
inline auto
operator/=(has_division<T1> &lhs, const T2 &rhs)
-> has_division<T1> & {
